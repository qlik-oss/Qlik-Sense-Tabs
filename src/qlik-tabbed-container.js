 ...
 */
define(['jquery', 'qlik', './properties', './css/styles.css'], function ($, qlik, props) {
  ...
  function showHelpText() {
    return $('<div/>', {
      ...
      .append($('<ul/>')
        .append($('<li/>', {
          text: `Create charts and add them as master items. (You can remove the charts from
          the sheet after you have added them to master items if you please)`
        }))
        .append($('<li/>', {
          text: `Drag and drop the "Container with tabs" extension onto the sheet.`
        }))
        .append($('<li/>', {
          text: `On the extension property panel, navigate to [Appearance] > [Tabs] Here you
          can change the number of tabs and assign master items to each tab.`
        }))
      );
  }
